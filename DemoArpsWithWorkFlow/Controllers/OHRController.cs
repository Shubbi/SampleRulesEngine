...
{
    public class OHRController : Controller
    {
        // GET: OHR
        public ActionResult Index()
        {
            ...
            if (arpsAward == null || arpsAward.Phase != DemoArps_Common.AwardPhase.Ohr)
            {
                throw new Exception();
            }
        ...
        public ActionResult Post(ArpsAward arpsAward, string button)
        {
            ...
            if (arpsAwardFromSession == null || arpsAwardFromSession.Phase != DemoArps_Common.AwardPhase.Ohr)
            {
                throw new Exception();
            }
